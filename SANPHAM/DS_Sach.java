    ...
    public void writeToFile(String outputtxt) {
        try {
            ...
            for (int i = 0; i < soLuong; i++) {
                ...
                String line = sach.getTenSP() + "," + sach.getNSX() + "," + sach.getGiaBan() + "," + sach.getGiaNhap() + "," + sach.getMaSach() + "," + tacGia.getTenTG()+","+tacGia.getQueQuan() + "," + sach.getNamXB();
